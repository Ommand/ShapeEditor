...
namespace ShapeEditor
{
    public partial class OpenGL
    {
        ...
        [DllImport(LIBRARY_INITDRAWTEXTOPENGL, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern void PrintText(int hdc, double x, double y, double z, [MarshalAs(UnmanagedType.LPWStr)]string font, int sizefont, [MarshalAs(UnmanagedType.LPWStr)]string text);
